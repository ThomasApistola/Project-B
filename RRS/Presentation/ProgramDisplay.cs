...
public static class ProgramDisplay
{
    ...
    private static void DisplayCreateNewCustomerAccount() 
    {
        ...
        DateTime Birthdate = Functions.RequestValidDate(true);
        int Age = Functions.CalculateAge(Birthdate);
        string Gender = Functions.RequestGender();
        ...
        if (AccountLogic.CreateNewCustomerAccount(Email, Password, FirstName, LastName, Gender, Age, PhoneNumber, "EN", 3)) 
        {
